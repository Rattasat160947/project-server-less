...
|-------------|-------------|---------------|
| B6631345 | นางสาวชุติกาญจน์ ชมกลาง | App Development (Node.js/Go), Git Structure|
| B6640583 | นายรัฐศาสตร์ ทองเสงี่ยม | Jenkins CI/CD, Docker, Kubernetes, Ansible |
| B6641085 | นางสาวชลธิชา สุขชาลี | Prometheus & Grafana Monitoring |
